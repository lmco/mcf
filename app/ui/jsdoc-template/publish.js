...
function buildMemberNav(items, itemHeading, itemsSeen, linktoFn) {
    ...
    if (items.length) {
        ...
        if (itemsNav !== '') {
            let itemID = itemHeading.toLowerCase().replace(' ', '-');
...
function buildNav(members) {
    ...
    var nav = '<h2>Flight Manual</h2>';
    var seen = {};
    var seenTutorials = {};

    var fmLink = '<a id="fm-link" href="/doc/flight-manual">Flight Manual</a>';
    var moduleDocLink = '<a id="mod-doc-link" href="/doc/developers">Modules</a>';

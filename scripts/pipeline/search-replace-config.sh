...
sed -i "s/\"defaultAdminPassword\": \"\",/\"defaultAdminPassword\": \"$DEFAULT_ADMIN_PASSWORD\",/" config/production.cfg
...
sed -i "s/\"defaultAdminPassword\": \"\",/\"defaultAdminPassword\": \"$DEFAULT_ADMIN_PASSWORD\",/" config/pipeline.cfg

...
sed -i "s/server: nfs_share_address/server: $NFS_SHARE_URL/" $CI_PROJECT_DIR/kubernetes/mcf/mcf-dev-pv.yaml
sed -i "s/server: nfs_share_address/server: $NFS_SHARE_URL/" $CI_PROJECT_DIR/kubernetes/mcf/mcf-prod-pv.yaml

...
kubectl create -f $ProjectDirectory/kubernetes/mcf/mongo-prod-pv.yaml -n prod
...
kubectl create -f $ProjectDirectory/kubernetes/mongo/mongo-prod-deployment.yaml -n prod

...
navigated to a project page, you will see a menu on the left-hand side of the
page. This provides various pages where you can view the project model elements
and browse the element tree, view project users, and edit project information
if you are an admin.

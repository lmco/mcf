...
#### Artifacts Storage
An Artifact represents arbitrary data or binary file. Example: PDF, docx,
dat, png, and any other binary file. Artifacts are stored in a local or
remote database. The location of storage depends on the Artifact strategy
being used.
...
database strategies. In the file are mulitple functions and classes which are

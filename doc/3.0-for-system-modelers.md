...
in the same organization or the default organization. On the element edit page, the 
system modeler has the ability to choose one of those different projects to select an 
